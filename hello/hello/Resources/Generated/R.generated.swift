...
struct R: Rswift.Validatable {
  ...
  struct reuseIdentifier {
    ...
    static let reuseIdentifier: Rswift.ReuseIdentifier<UIKit.UITableViewCell> = Rswift.ReuseIdentifier(identifier: "reuseIdentifier")
...
struct _R: Rswift.Validatable {
  ...
  struct storyboard: Rswift.Validatable {
    ...
    struct initial: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      typealias InitialController = ListViewControllerTableViewController
