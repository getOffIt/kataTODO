...
struct R: Rswift.Validatable {
  ...
  struct reuseIdentifier {
    /// Reuse identifier `TODOCELLreuseIdentifier`.
    static let todocelLreuseIdentifier: Rswift.ReuseIdentifier<UIKit.UITableViewCell> = Rswift.ReuseIdentifier(identifier: "TODOCELLreuseIdentifier")
...
struct _R: Rswift.Validatable {
  ...
  struct storyboard: Rswift.Validatable {
    ...
    struct main: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      typealias InitialController = TodoTableViewController
